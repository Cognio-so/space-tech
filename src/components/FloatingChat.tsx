...
const PHONE_MAIN = "+918587951091";
const WHATSAPP_NUMBER = "918587951091";
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          <Button
            size="lg"
            className="gap-2 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white shadow-lg hover:shadow-xl transition-shadow"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
